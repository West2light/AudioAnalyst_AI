...
try:
    ...
    print("⚠️ Vui lòng chạy file mergeFeat_x.py trước để tạo file merged_embeddings.csv")
    exit(1)
...
disp.plot()
plt.title("Confusion Matrix - Random Forest (Mean Embedding)")
...
feature_importance = pd.DataFrame({
    'feature': [f'embedding_{i}' for i in range(X.shape[1])],
...
scaler_path = 'output/rf_scaler.joblib'
...
feature_importance.to_csv('output/feature_importance_rf.csv', index=False)
print("✅ Đã lưu feature importance tại: output/feature_importance_rf.csv")