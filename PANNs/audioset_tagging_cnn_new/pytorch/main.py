...
##Test
def is_dangerous(clipwise_output, labels, threshold=0.5):
    dangerous_labels = ["Explosion", "Gunshot", "Scream", "Alarm"]
    for label, prob in zip(labels, clipwise_output):
        if label in dangerous_labels and prob > threshold:
            return True
    return False
